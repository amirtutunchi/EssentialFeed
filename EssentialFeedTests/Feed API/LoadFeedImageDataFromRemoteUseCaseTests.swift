...
class LoadFeedImageDataFromRemoteUseCaseTests: XCTestCase {
    ...
    func test_loadImageFromURL_requestsDataFromURL() {
    ...
    func test_loadImageFromURL_deliversConnectivityErrorOnClientError() {
    ...
    func test_loadImageFromURL_deliversInvalidDataErrorOnNon200HTTPResponse() {
        let (sut, client) = makeSUT()
    ...
    func test_loadImageFromURL_deliversInvalidDataErrorOn200HTTPResponseWithEmptyData() {
        let (sut, client) = makeSUT()
    ...
    func test_loadImageFromURL_deliversReceivedNonEmptyDataOn200HTTPResponse() {
        let (sut, client) = makeSUT()
    ...
    func test_loadImageFromURL_doesNotDeliverResultAfterSUTInstanceHasBeenDeallocated() {
